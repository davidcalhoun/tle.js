...
describe('getGroundTracks', () => {
    ...
    test('1', async () => {
        ...
        expect(lastLng).toBeCloseTo(179.9936446);
    });
    ...
    test('2', async () => {
        ...
        expect(result[1][0][0]).toBeCloseTo(-179.682);
...
2 24901   5.0867  62.6208 0007858 138.4124 258.4388  0.99995119 73683`;
    ...
    test('getLatLon', () => {
        const timestamp = 1501039265000;
        const result = getLatLngObj(tleStr, timestamp);
        expect(result.lat).toBeCloseTo(4.3530169);
        expect(result.lng).toBeCloseTo(129.6325452);
    });
    ...
    test('getLastAntemeridianCrossingTimeMS 2', () => {
        ...
        expect((timestamp - result) / 1000 / 60).toBeCloseTo(72.5);
    });
